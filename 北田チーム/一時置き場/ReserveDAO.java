...
public class ReserveDAO {
	...
	public void  insert( Reserve  reserve) throws SQLException{
		...
		public ArrayList<Resource> search(LocalDateTime lendDate,LocalDateTime returnDate, int classId)throws SQLException {
			Resource a = null;
			...
			try {
				...
				String sql = "SELECT * FROM reserve A, resource B where A.resourceid=B.resourceid AND B.classid = " + classId +"  AND NOT((A.LENDDATE < '2018-01-01' AND A.RETURNDATE > '2018-01-01') OR (A.LENDDATE < '2018-01-31' AND A.RETURNDATE < '2018-01-31') OR A.LENDDATE > '2018-01-01' AND A.RETURNDATE < '2018-01-31')";;
