...
<jsp:useBean id="employee" class="dto.EmployeeDTO" scope="session" />
...
<body>
	...
	<c:if test="${employeeDTO.managerId==10 }">
	...
	<form method="post" action="/ResourceManagement/ControllerServlet">
		<input type="submit" name="LOGOFF" value="ログオフ" class="btn btn-info"> <input
