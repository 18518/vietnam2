...
<div class="jumbotron form-group">
	...
	<div class="panel-body">
		...
		<c:forEach var="i" begin="1" end="${deleteConfirmDTO.size() }" step="1">
			<tr>
				<td>${i}</td>
				<td>${deleteConfirmDTO[i-1].resourceName }</td>
			</tr>
		</c:forEach>
		</thead>
	</table>
	...
	<a href="/ResourceManagement/ControllerServlet?COMMAND=DELETECOMPLETE"><input type="button" value="削除" class="btn btn-info"></a>
