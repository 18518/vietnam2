...
<body>
	...
	追加したいリソースの種別を選択してください<br><br>
		<c:forEach var="resourceClass" items="${resourceAddDTO }">
			<input type="radio" name="class" value="${resourceClass.classId }">${resourceClass.className}<br>
		</c:forEach>
		<input type="radio" name="class" value="other">その他
		<input type="text" name="className"><br>
		<input type="hidden" name="COMMAND" value="ADDRESOURCEINPUT"><br>
		<input type="submit" name="add" value="追加" class="btn btn-info">
